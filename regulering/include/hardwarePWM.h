...
#define PWMsetup \
  ...
  MCPWM0.channel[0].generator[0].utea = 1;       /* Set the PWM0A ouput to go low at the start of the timer period*/\
  MCPWM0.channel[0].generator[0].utez = 2;       /* High on compare match*/\
